...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); //removing CHILD
...
},{}],"logout-logout.js":[function(require,module,exports) {
"use strict";
...
//exporting display mapbox as a function
var displayMap = function displayMap(locations) {
  ...
  var bounds = new mapboxgl.LngLatBounds(); //looping through all locations
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //now extends map bounds to include current location
...
var stripe = Stripe('pk_test_a1b9Fzfq0cE6OkJPZ7Pu4XnD00fCRVyX1f');
...
var _logoutLogout = require("./logout-logout");
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _logoutLogout.login)(email, password);
  });
}

; //logout

if (logoutBtn) logoutBtn.addEventListener('click', _logoutLogout.logout); //submit data
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); //to give the user some feedback when saving
            //1)
          ...
          case 7:
            ...
            //1)
            document.querySelector('.btn--save-password').textContent = 'Save Password'; //to clear data from frontend after updating
